...
float HARD_AI_SPEED_HANDICAP = 0.5;

float MEDIUM_AI_COST_HANDICAP = 0.1;
float MEDIUM_AI_SPEED_HANDICAP = 0.75;

float EASY_AI_COST_HANDICAP = 0.1;
...
#define cfgDEFAULT_MAP "[TM]DuelII.bzn";
#define cfgDEFAULT_MAP_TITLE "[2] Duel II";
